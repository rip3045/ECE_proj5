...
Modified by Tuan Luong to fit the objective of AEM 591 project
...
def dubins_traj(param,sample_no):
    ...
    step = length / sample_no
    path = -1 * np.ones((sample_no,3))
...
def main():
    ...
    pt1 = Waypoint(0,-15,-90)
    pt2 = Waypoint(-5,20,-180)
